...
import SlideMenu, { SideMenuRef } from './SlideMenu'
const EMPTY_CONFIG = [
    ...
    return (
      ...
      >
        ...
        <View style={styles.infoLayout}>
          ...
          <View style={{ flex: 1 }} />
          <TouchableOpacity style={[styles.infoButton, { marginRight: 15 }]}>
            <Text style={styles.editTxt}>编辑资料</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.infoButton, { marginLeft: 0 }]}>
